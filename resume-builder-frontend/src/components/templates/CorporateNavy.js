...
const CorporateNavy = ({ resume }) => {
  ...
  const fontFamily = formatting?.fontFamily || 'Georgia, Cambria, serif';

  return (
    <div 
      className="canonical-resume corporate-navy"
      style={{
        fontFamily,
        color: '#111827',
    ...
    >
      ...
      <header data-section="personal" style={{ textAlign: 'center', borderBottom: `2px solid ${accentColor}`, paddingBottom: '14px', marginBottom: '16px' }}>
        ...
        <h1 style={{ fontSize: '20pt', fontWeight: 700, margin: 0, color: accentColor, textTransform: 'uppercase', letterSpacing: '0.04em' }}>
          {personal?.fullName || 'Your Name'}
        </h1>
        {personal?.title && (
          <div style={{ fontSize: '10.5pt', fontWeight: 600, color: '#374151', fontStyle: 'italic', marginTop: '2px' }}>
            {personal.title}
          </div>
        )}
        <div style={{ fontSize: '8.5pt', color: '#4b5563', marginTop: '6px', display: 'flex', justifyContent: 'center', flexWrap: 'wrap', gap: '10px' }}>
          ...
          case 'summary':
            ...
            return (
              <section key="summary" data-section="summary" className="resume-section" style={{ marginBottom: '14px' }}>
                <h2 style={{ fontSize: '9.5pt', fontWeight: 700, textTransform: 'uppercase', letterSpacing: '0.06em', color: accentColor, borderBottom: '1px solid #e5e7eb', paddingBottom: '2px', marginBottom: '4px', breakAfter: 'avoid', pageBreakAfter: 'avoid' }}>
                  Executive Summary
                </h2>
                <p style={{ margin: 0, color: '#374151', fontSize: '9.5pt', lineHeight: 1.5, textAlign: 'justify' }}>
                  {personal.summary}
                </p>
              </section>
            );
          ...
          case 'experience':
            ...
            return (
              <section key="experience" data-section="experience" className="resume-section" style={{ marginBottom: '16px' }}>
                <h2 style={{ fontSize: '9.5pt', fontWeight: 700, textTransform: 'uppercase', letterSpacing: '0.06em', color: accentColor, borderBottom: '1px solid #e5e7eb', paddingBottom: '2px', marginBottom: '8px', breakAfter: 'avoid', pageBreakAfter: 'avoid' }}>
                      ...
                      <div key={exp.id || idx} className="experience-item" style={{ breakInside: 'avoid', pageBreakInside: 'avoid' }}>
                        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'baseline', flexWrap: 'wrap' }}>
                          <div>
                            ...
                            <span style={{ fontSize: '9.5pt', color: '#4b5563' }}>, <em>{exp.company}</em></span>
          ...
          case 'skills':
            ...
            return (
              <section key="skills" data-section="skills" className="resume-section" style={{ marginBottom: '14px', breakInside: 'avoid', pageBreakInside: 'avoid' }}>
                <h2 style={{ fontSize: '9.5pt', fontWeight: 700, textTransform: 'uppercase', letterSpacing: '0.06em', color: accentColor, borderBottom: '1px solid #e5e7eb', paddingBottom: '2px', marginBottom: '6px', breakAfter: 'avoid', pageBreakAfter: 'avoid' }}>
                  Core Competencies & Expertise
                </h2>
                <div style={{ fontSize: '9.5pt', color: '#374151', lineHeight: 1.6 }}>
                  {skills.map(s => {
                    ...
                    <div key={proj.id || idx} className="project-item" style={{ marginBottom: '6px', breakInside: 'avoid', pageBreakInside: 'avoid' }}>
                      <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'baseline', flexWrap: 'wrap' }}>
                        <div>
                          ...
                          {proj.role && <span style={{ fontSize: '9pt', color: '#4b5563', fontStyle: 'italic' }}> — {proj.role}</span>}
                        </div>
                        {proj.link && (
                          <ResumeLink 
                            href={proj.link} 
                      ...
                      {techStr && (
                        <div style={{ fontSize: '8.5pt', color: '#4b5563', fontStyle: 'italic', margin: '1px 0' }}>
                          Tech: {techStr}
                        </div>
                      )}
                ...
                {education.map((edu, idx) => (
                  <div key={edu.id || idx} className="education-item" style={{ marginBottom: '4px', breakInside: 'avoid', pageBreakInside: 'avoid' }}>
                    <div style={{ display: 'flex', justifyContent: 'space-between', fontSize: '9.5pt' }}>
                      ...
                      <span style={{ color: '#4b5563', fontSize: '8.5pt' }}>{edu.startDate} — {edu.endDate}</span>
                    </div>
            ...
            return (
              <section key="certifications" data-section="certifications" className="resume-section" style={{ marginBottom: '14px' }}>
                ...
                {certifications.map((c, idx) => {
                  ...
                  return (
                    <div key={c.id || idx} className="certification-item" style={{ fontSize: '9.5pt', color: '#374151', marginBottom: '2px', breakInside: 'avoid', pageBreakInside: 'avoid' }}>
            ...
            return (
              <section key="publications" data-section="publications" className="resume-section" style={{ marginBottom: '14px' }}>
                ...
                {publications.map((p, idx) => (
                  <div key={p.id || idx} className="publication-item" style={{ fontSize: '9.5pt', color: '#374151', marginBottom: '2px', breakInside: 'avoid', pageBreakInside: 'avoid' }}>
          ...
          case 'awards':
            ...
            return (
              <section key="awards" data-section="awards" className="resume-section" style={{ marginBottom: '14px' }}>
                ...
                {awards.map((a, idx) => (
                  <div key={a.id || idx} className="award-item" style={{ fontSize: '9.5pt', color: '#374151', marginBottom: '2px', breakInside: 'avoid', pageBreakInside: 'avoid' }}>
          ...
          case 'volunteer':
            ...
            return (
              <section key="volunteer" data-section="volunteer" className="resume-section" style={{ marginBottom: '14px' }}>
                ...
                {volunteer.map((v, idx) => (
                  <div key={v.id || idx} className="volunteer-item" style={{ fontSize: '9.5pt', color: '#374151', marginBottom: '2px', breakInside: 'avoid', pageBreakInside: 'avoid' }}>
              ...
              <React.Fragment key="custom">
                {customSections.map((cs, idx) => (
                  <section key={cs.id || idx} data-section="custom" className="resume-section" style={{ marginBottom: '14px' }}>
                    ...
                    <p style={{ margin: 0, fontSize: '9.5pt', color: '#374151', whiteSpace: 'pre-line' }}>{cs.content}</p>
                  </section>
                ))}
              </React.Fragment>
            );
